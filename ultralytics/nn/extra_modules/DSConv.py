...
class Bottleneck(nn.Module):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3,3), e=0.5):
        ...
        self.c1 = Conv(c1, c_, k[0], 1)
        self.c2 = Conv(c_, c2, k[1], 1)
...
class Bottleneck_DySnakeConv(Bottleneck):
    ...
    def forward(self, x):
        return x + self.cv3(self.cv2(self.c1(x))) if self.add else self.cv3(self.cv2(self.c1(x)))
...
if __name__ == "__main__":
    ...
    mobilenet_v1 = C3k_DSConv(64, 64, c3k=True)
